 ...
 *   Copyright 2021 by Liu Bangguo <liubangguo@jingos.com>                     *
 *                                                                             *
...
void LookAndFeelPackage::initPackage(KPackage::Package *package)
{
    ...
    package->addDirectoryDefinition("messagebox", QStringLiteral("messagebox"), i18n("On-Screen Display Notifications"));
    package->addFileDefinition("messageboxmainscript", QStringLiteral("messagebox/Messagebox.qml"), i18n("Main Script for On-Screen Display Notifications"));
